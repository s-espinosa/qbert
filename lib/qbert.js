...
Qbert.prototype.update = function() {
  if (this.nextPosition === null && this.y < 950) {
    ...
    this.board.cubes[this.currentPosition].active = true;
    this.board.cubes[this.currentPosition].drawCube ();
  }
  console.log("X: " + this.x + ", Y: " + this.y + " Y Velocity:" + this.yVelocity);
};
