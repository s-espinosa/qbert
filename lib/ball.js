...
Ball.prototype.jumpIntervalElapsed = function(tick) {
...
Ball.prototype.leavingScreen = function() {
  return this.nextPosition === null && this.y > 620;
};
...
Ball.prototype.isInSitu = function(){
    this.jumping         = false;
    this.xVelocity       = 0;
    this.yVelocity       = 0;
